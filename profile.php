...
// 1. PROSES UPDATE PROFIL & FOTO (Tab Profil)
...
// 2. PROSES UPDATE ALAMAT SAJA (Tab Alamat - Modal)
...
// Logika Tampilan Avatar (Pakai foto jika ada, pakai inisial jika kosong)
$avatar_html = "";
if (!empty($user['foto']) && file_exists("frontend/images/profil/" . $user['foto'])) {
    ...
    $avatar_html = '<div class="rounded-circle d-flex justify-content-center align-items-center profile-avatar mb-3 shadow-sm" style="width: 100px; height: 100px; font-size: 3rem;">' . $inisial . '</div>';
    $avatar_sidebar = '<div class="rounded-circle d-flex justify-content-center align-items-center profile-avatar me-3" style="width: 50px; height: 50px; font-size: 1.5rem;">' . $inisial . '</div>';
}
?>
...
<head>
    ...
    <style>
        ...
        .profile-avatar { background-color: var(--xriva-dark); color: white; }
        
        @media (max-width: 768px) {
            .form-label-custom { text-align: left; }
        }
    </style>
</head>
<body class="bg-light">
        ...
        <div class="col-md-3 mb-4">
            ...
            <div class="sidebar-menu" style="font-size: 0.95rem;">
                <div class="d-flex align-items-center text-sage-dark fw-bold mb-3">
                    <i class="fas fa-user text-primary me-3" style="color: var(--xriva-dark) !important;"></i> Akun Saya
                </div>
                <div class="ms-4 mb-4">
                    ...
                    <a class="d-block text-muted text-decoration-none menu-tab" data-target="password">Ubah Password</a>
                </div>
                ...
                <a href="wishlist.php" class="d-flex align-items-center text-muted text-decoration-none mb-3">
                    <i class="fas fa-heart text-warning me-3"></i> Wishlist Saya
                </a>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div id="pane-profil" class="content-pane">
                        ...
                        <p class="text-muted small mb-4 pb-3 border-bottom">Kelola informasi profil Anda untuk mengontrol dan mengamankan akun</p>
                        ...
                        <div class="row mt-4">
                            <form method="POST" enctype="multipart/form-data" class="d-flex flex-wrap w-100">
                                ...
                                <div class="col-md-4 text-center mt-4 mt-md-0 d-flex flex-column align-items-center justify-content-start pt-3">
                                    <div class="mb-3">
                                        <?= $avatar_html ?>
                                    </div>
                                    
                                    <input type="file" name="foto_profil" id="foto_profil" class="d-none" accept="image/jpeg, image/png">
                                    <label for="foto_profil" class="btn btn-outline-secondary btn-sm px-4 mb-2 cursor-pointer" id="label_foto">Pilih Gambar</label>
                        ...
                        <div class="border rounded p-3 mb-3">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <span class="badge bg-sage-dark">Utama</span>
                                </div>
                                <div>
                    ...
                    <div id="pane-password" class="content-pane" style="display: none;">
                        ...
                        <p class="text-muted small mb-4 pb-3 border-bottom">Untuk keamanan akun Anda, mohon tidak menyebarkan password Anda ke orang lain.</p>
                        <div class="row mt-4">
                            <div class="col-md-9 pe-md-4">
                                <form>
                                    <div class="row mb-4 align-items-center">
                                        <label class="col-sm-4 form-label-custom">Password Saat Ini</label>
                                        <div class="col-sm-8"><input type="password" class="form-control"></div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <label class="col-sm-4 form-label-custom">Password Baru</label>
                                        <div class="col-sm-8"><input type="password" class="form-control"></div>
                                    </div>
                                    <div class="row mt-5">
                                        <div class="col-sm-4"></div>
                                        <div class="col-sm-8"><button type="button" class="btn btn-sage px-5 py-2 fw-bold shadow-sm">Konfirmasi</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fw-bold text-sage-dark">Ubah Alamat Pengiriman</h5>
      ...
      <form method="POST">
          <div class="modal-body">
              <div class="mb-3">
                  ...
                  <div class="form-text">Pastikan menyertakan RT/RW, Kelurahan, Kecamatan, dan Kota/Kabupaten.</div>
              </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
            <button type="submit" name="update_alamat_saja" class="btn btn-sage fw-bold">Simpan Alamat</button>
          </div>
      </form>
    </div>
  </div>
...
<script>
    ...
    document.getElementById('foto_profil').addEventListener('change', function(e) {
        ...
        document.getElementById('label_foto').innerText = fileName;
        document.getElementById('label_foto').classList.remove('btn-outline-secondary');
        document.getElementById('label_foto').classList.add('btn-sage'); // Berubah warna saat file siap
    });
</script>
</body>
</html>